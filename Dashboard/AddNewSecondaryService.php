...
echo $row['COUNT(ID)'] ;
          ...
          <li>
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Flavour</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
                <div class="row">
                                              ...
                                              <div class="col-lg-12">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>New Flavour</strong>
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="addNewSecondaryWorkingSite.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                             ...
                             <div class="col-9 col-md-9"><input type="text" id="Name" name="Name"  class="input-sm form-control-sm form-control"  required></div></div>        
   ...
   <div class="container-fluid">
                <div class="row">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Existing Flavour</strong>
                            </div>
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`,`Photo`, `Name`, `isActive`, `Date`, `Time` FROM `subsubmenu` s WHERE isActive=1");
                        if(!empty($users)): $count = 0; foreach($users as $user): $count++;
                    ?>
                    <tr>
                        <td><?php echo $count; ?></td>
                          <td><a href="EditNewSecondaryService.php?id=<?php echo $user['ID']; ?>" style="display:block;color: blue;"><u><?php echo $user['Name']; ?></u></a></td>
                              
                              
                        <td><a href="SiteDeleteLinkNewSecondary.php?id=<?php echo $user['ID']; ?>" style="color: red;"><?php echo "DEL"; ?></td>
                    ...
                    <?php endif; ?>
                      ...
                      <div class="card">
                            <div class="card-header">
                                <strong class="card-title">In Active Flavour</strong>
                            </div>
                      ...
                      $conn = $db->connect();
                        $date=date("Y-m-d");
                         $server_ip="139.59.38.160";
                        $users =$conn->query("SELECT `ID`,`Name`, `isActive`, `Date`, `Time` FROM `subsubmenu` s WHERE isActive=0");
                        if(!empty($users)): $count = 0; foreach($users as $user): $count++;
                    ?>
                    <tr>
                        <td><?php echo $count; ?></td>
                        ...
                        <td><a href="SiteActiveLinkNewSecondary.php?id=<?php echo $user['ID']; ?>" style="color: green;"><?php echo "Activate"; ?></td>
