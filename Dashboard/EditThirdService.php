...
<head>
    ...
    <title>EDIT Third Service</title>
         ...
         var i;
             if(arr.length!=0){
                               ...
                               for( i=0;i<arr.length;i++){
                                 ...
                                 document.getElementById('role').value=arr[i].PrimaryService;
                    
                               }
             }
  }
}
 xmlhttp.open("POST","getThirdService.php",true);
  ...
  <h3 class="menu-title">Extras</h3><!-- /.menu-title -->
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add Third Service</li>
                        </ol>
                    </div>
                </div>
            </div>
           ...
           <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                                              ...
                                              <div class="col-lg-12">
                                                 <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="editWorkingSiteThird.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                             ...
                             <div class="col-9 col-md-9"><input type="text" id="ID" name="ID" placeholder="Enter the name" class="input-sm form-control-sm form-control"  required></div>
   ...
   <option value="0">--Select--</option>
        ...
        echo "Could not connect to DBMS"; 
         }else {  $sql =$conn->query("SELECT `ID`, `Category` FROM `submenu` ");
        foreach($sql as $row) {
    ?>
