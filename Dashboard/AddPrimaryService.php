            ...
            <div class="container-fluid">
                <div class="row">
                             ...
                             <div class="col-9 col-md-9" style="margin: 10;"><textarea id="Description" name="Description" rows="9" placeholder="Description..." class="form-control"></textarea></div></div>
                                ...
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">App color </label></div>
                             <div class="col-9 col-md-9" style="margin: 10;"><textarea id="color" name="color" rows="1" placeholder="Select a color to show in app..." class="form-control"></textarea> 
                ...
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Primary Category</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
