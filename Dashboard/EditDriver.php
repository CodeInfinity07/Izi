...
<td> <a href="AddDrivers.php?id=<?php echo $user["ID"];?>" style="color:blue;">Edit</a></td>

<td>   <button type="button" class="btn btn-secondary mb-1" onclick="myFunct(<?php echo $user['ID']; ?>)">
                            Delete
                        </button></td>
                    </tr>
                    <?php endforeach; else: ?>
...
function myFunct(id) {
  ...
  window.location.replace("http://139.59.38.160/IziGourmet/Dashboard/DeleteDriver.php?id="+id);
  } 
}
</script>
