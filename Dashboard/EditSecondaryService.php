                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                           <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="AddStockies.php">Add Stockies</a></li>    
                                  <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="EditStockies.php">Edit Stokies</a></li>    
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                                              ...
                                              <div class="col-lg-12">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>Edit Secondary Category</strong>
                                                    </div>
                             ...
                             <div class="col col-md-3"><label for="text-input" class=" input-sm form-control-sm form-control-label">Specification</label></div>
                             <div class="col-9 col-md-9"><input type="text" id="special" name="special" placeholder="Enter the specification" class="input-sm form-control-sm form-control"  required></div>    


                            
                               <div class="col col-md-3"><label for="text-input" class=" input-sm form-control-sm form-control-label">Description </label></div>
                             <div class="col-9 col-md-9" style="margin: 10;"><textarea id="Description" name="Description" rows="9" placeholder="Description..." class="form-control"></textarea></div>
                          
                           <div class="col col-md-3" style="padding: 20px;"><label for="text-input" class=" input-sm form-control-sm form-control-label">Browse Image</label></div>
                              <div class="col-8 col-md-8" style="padding: 20px;"><input type="file" id="photo" name="photo" class="input-sm form-control-sm form-control-file"></div>
