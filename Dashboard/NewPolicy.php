                ...
                <div class="row">
                                              ...
                                              <div class="col-lg-6">
                                                 <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="addPolicies.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                            ...
                            <div class="col-6 col-md-6"><textarea type="text" lines=4 id="Details" name="Details"  class="input-sm form-control-sm form-control" required=""></textarea></div>
                             ...
                             <div class="col col-md-3"><label for="text-input" class=" input-sm form-control-sm form-control-label">Links</label></div>
                              <div class="col-9 col-md-9"><input type="text" id="Links" name="Links" placeholder="copy and paste from addressbar" class="input-sm form-control-sm form-control" ></div>
                        ...
                        <div class="card" >
                            <div class="card-header">
                                <strong class="card-title">Policies</strong>
                            </div>
