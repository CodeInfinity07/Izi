...
<head>
    ...
    <title>IziGourmet Dashboard Messages</title>
                    ...
                    <div class="col-md-12">
                        <div class="card" >
                         <div class="card-header">
                                <strong class="card-title"> Comments from App</strong>
                            </div>
                            <div class="card-body" >
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`, `IDUser`, `Email`, `Messages`, `Date`, `Time` FROM `contactus` ORDER BY ID DESC");
