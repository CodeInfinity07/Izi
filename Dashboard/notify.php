...
if($check1 && $check2 && $check3 && $check4) {
    header('Location: http://139.59.38.160/IziGourmet/Dashboard/latlongPaid.php?id='.$ID);
} else {
    header('Location: http://139.59.38.160/IziGourmet/Dashboard/cancelled.php?id='.$ID);
}
