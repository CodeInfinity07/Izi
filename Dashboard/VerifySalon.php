            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      $conn = $db->connect();
                        $date=date("Y-m-d");
                         ...
                         if($id==1){
                               $users =$conn->query("SELECT `ID`, `parlour_name`, `parlour_about`, `Photo`, `parlour_email`, `parlour_mobile`, `parlour_registration`, `parlour_address`, `parlour_city`, `parlour_locality`, `parlour_pin`, (SELECT Location FROM service_location_at WHERE ID=p.service_location ) AS `service_location` , `latitude`, `longitude`, `isVerified`, `isHold`, `isDeleted`, `Ladies`, `Gents`, `Bridal`, `Tattoo`, `Kids`, `discountType`, `discountAmt`, `Reference_Code`, `AppInstallation_Date`, `AppInstallation_Time`, `isSechedule`, `isSpecialist`, `isLocation`, `isServiceAt`, `Date`, `Time`, `IP` FROM `Shop_registration` p ");
                             }elseif($id==2){
                                   $users =$conn->query("SELECT `ID`, `parlour_name`, `parlour_about`, `Photo`, `parlour_email`, `parlour_mobile`, `parlour_registration`, `parlour_address`, `parlour_city`, `parlour_locality`, `parlour_pin`, (SELECT Location FROM service_location_at WHERE ID=p.service_location ) AS `service_location` , `latitude`, `longitude`, `isVerified`, `isHold`, `isDeleted`, `Ladies`, `Gents`, `Bridal`, `Tattoo`, `Kids`, `discountType`, `discountAmt`, `Reference_Code`, `AppInstallation_Date`, `AppInstallation_Time`, `isSechedule`, `isSpecialist`, `isLocation`, `isServiceAt`, `Date`, `Time`, `IP` FROM `Shop_registration` p  WHERE isVerified=0");
                             }elseif($id==3){
                                   $users =$conn->query("SELECT `ID`, `parlour_name`, `parlour_about`, `Photo`, `parlour_email`, `parlour_mobile`, `parlour_registration`, `parlour_address`, `parlour_city`, `parlour_locality`, `parlour_pin`, (SELECT Location FROM service_location_at WHERE ID=p.service_location ) AS `service_location` , `latitude`, `longitude`, `isVerified`, `isHold`, `isDeleted`, `Ladies`, `Gents`, `Bridal`, `Tattoo`, `Kids`, `discountType`, `discountAmt`, `Reference_Code`, `AppInstallation_Date`, `AppInstallation_Time`, `isSechedule`, `isSpecialist`, `isLocation`, `isServiceAt`, `Date`, `Time`, `IP` FROM `Shop_registration` p  WHERE isVerified=1");
                             }
                    ...
                    <tr>
                        ...
                        <td><a href="Profile.php?id=<?php echo $user['ID']; ?>" style="display:block;color: blue;"><u><?php echo $user['parlour_name']; ?></u></a></td>
                            <td><?php echo $user['parlour_email']; ?></td>
                          <td><?php echo $user['parlour_mobile']; ?></td>
                          <td><img src="<?php echo 'http://' . $server_ip .'/' .'IziGourmet' .'/'.'App'.'/'.'Shop_images'.'/'.$user["Photo"];?>" width='48' height='48'></td>
                        
                                <td><?php echo $user['parlour_address']; ?></td>
                                      <td><?php echo $user['parlour_registration']; ?></td>
                                            <td><?php echo $user['parlour_pin']; ?></td>
