    ...
    if (this.readyState==4 && this.status==200) {
         ...
         var i;
             if(arr.length!=0){
                       ...
                       document.getElementById('address1').value=arr[i].Address;
                                  ...
                                  document.getElementById('Latitude').value=arr[i].Latitude;
                                    ...
                                    document.getElementById('Longitude').value=arr[i].Longitude;
                                        document.getElementById('distance').value=arr[i].Distance;
                               }
             }
  }
}
 xmlhttp.open("POST","getShops.php",true);
       ...
       <div class="content-body">
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Shops</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
                <div class="row">
                                              ...
                                              <div class="col-lg-12">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>Edit Shopsy</strong>
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="addStoreLocation.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                             ...
                             <div class="col-9 col-md-9"><input type="text" id="ID" name="ID"  class="input-sm form-control-sm form-control" readonly  ></div></div>                               
                              <div class="row input-group">                   
