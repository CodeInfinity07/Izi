...
if (isset($_POST['giver_mobile'])){
    ...
    $IP=test_input($IP);
     ...
     $res = $db->createOTPOwner($IP,$name,$mobile,$otp);
   ...
   function sendSms($mobile, $otp) {
    ...
    $message = urlencode("Hello! Welcome to HelloCab. Your OTP is '$otp_prefix $otp'. Please do not share the OTP with anyone for security reason");
